...
My current laptop is an M1 MacBook Air that I received in 2021 in order to graduate college. It is a great machine and the never ending battery life continues to prevent me from looking for a new device. Meanwhile, the machine I've most recently acquired is a Beelink SER8 with 64 GB of RAM and 2 TB of storage. This device has a fantastic price to performance ratio and serves my every need, including open source development. It also provides my fiancé and I with a lovely "family" desktop that we share. Because of this, I am hesitant to make the hop to Linux as I want to keep the device as a safe space for backup storage and document processing that my fiancé can also utilize.
